...
-- | The state query protocol is likely the most versatile of the three Shardagnostic
...
import Ogmios.Data.Json.Query
    ( QueryInEra, SomeQuery (..), SomeSophieEra (..), fromEraIndex )
...
withCurrentEra
    ...
    => QueryInEra f block
    -> (Maybe (SomeSophieEra, SomeQuery f block) -> m (LSQ.ClientStAcquired block point query m ()))
    -> m (LSQ.ClientStAcquired block point query m ())
