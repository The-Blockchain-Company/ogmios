...
export type SubmitTxErrorSophie =
  | AddressAttributesTooLarge
  | AlreadyDelegating
  | BadInputs
  | CollateralHasNonBccAssets
...
export const errors = {
  EraMismatch: {
    assert: (item: SubmitTxErrorSophie): item is EraMismatch =>
  ...
  InvalidWitnesses: {
    assert: (item: SubmitTxErrorSophie): item is InvalidWitnesses =>
  ...
  MissingVkWitnesses: {
    assert: (item: SubmitTxErrorSophie): item is MissingVkWitnesses =>
  ...
  MissingScriptWitnesses: {
    assert: (item: SubmitTxErrorSophie): item is MissingScriptWitnesses =>
  ...
  ScriptWitnessNotValidating: {
    assert: (item: SubmitTxErrorSophie): item is ScriptWitnessNotValidating =>
  ...
  InsufficientGenesisSignatures: {
    assert: (item: SubmitTxErrorSophie): item is InsufficientGenesisSignatures =>
  ...
  MissingTxMetadata: {
    assert: (item: SubmitTxErrorSophie): item is MissingTxMetadata =>
  ...
  MissingTxMetadataHash: {
    assert: (item: SubmitTxErrorSophie): item is MissingTxMetadataHash =>
  ...
  TxMetadataHashMismatch: {
    assert: (item: SubmitTxErrorSophie): item is TxMetadataHashMismatch =>
  ...
  BadInputs: {
    assert: (item: SubmitTxErrorSophie): item is BadInputs =>
  ...
  ExpiredUtxo: {
    assert: (item: SubmitTxErrorSophie): item is ExpiredUtxo =>
  ...
  TxTooLarge: {
    assert: (item: SubmitTxErrorSophie): item is TxTooLarge =>
  ...
  MissingAtLeastOneInputUtxo: {
    assert: (item: SubmitTxErrorSophie): item is MissingAtLeastOneInputUtxo =>
  ...
  InvalidMetadata: {
    assert: (item: SubmitTxErrorSophie): item is InvalidMetadata =>
  ...
  FeeTooSmall: {
    assert: (item: SubmitTxErrorSophie): item is FeeTooSmall =>
  ...
  ValueNotConserved: {
    assert: (item: SubmitTxErrorSophie): item is ValueNotConserved =>
  ...
  NetworkMismatch: {
    assert: (item: SubmitTxErrorSophie): item is NetworkMismatch =>
  ...
  OutputTooSmall: {
    assert: (item: SubmitTxErrorSophie): item is OutputTooSmall =>
  ...
  AddressAttributesTooLarge: {
    assert: (item: SubmitTxErrorSophie): item is AddressAttributesTooLarge =>
  ...
  DelegateNotRegistered: {
    assert: (item: SubmitTxErrorSophie): item is DelegateNotRegistered =>
  ...
  UnknownOrIncompleteWithdrawals: {
    assert: (item: SubmitTxErrorSophie): item is UnknownOrIncompleteWithdrawals =>
  ...
  StakePoolNotRegistered: {
    assert: (item: SubmitTxErrorSophie): item is StakePoolNotRegistered =>
  ...
  WrongRetirementEpoch: {
    assert: (item: SubmitTxErrorSophie): item is WrongRetirementEpoch =>
  ...
  WrongPoolCertificate: {
    assert: (item: SubmitTxErrorSophie): item is WrongPoolCertificate =>
  ...
  StakeKeyAlreadyRegistered: {
    assert: (item: SubmitTxErrorSophie): item is StakeKeyAlreadyRegistered =>
  ...
  PoolCostTooSmall: {
    assert: (item: SubmitTxErrorSophie): item is PoolCostTooSmall =>
  ...
  StakeKeyNotRegistered: {
    assert: (item: SubmitTxErrorSophie): item is StakeKeyNotRegistered =>
  ...
  RewardAccountNotExisting: {
    assert: (item: SubmitTxErrorSophie): item is RewardAccountNotExisting =>
  ...
  RewardAccountNotEmpty: {
    assert: (item: SubmitTxErrorSophie): item is RewardAccountNotEmpty =>
  ...
  WrongCertificateType: {
    assert: (item: SubmitTxErrorSophie): item is WrongCertificateType =>
  ...
  UnknownGenesisKey: {
    assert: (item: SubmitTxErrorSophie): item is UnknownGenesisKey =>
  ...
  AlreadyDelegating: {
    assert: (item: SubmitTxErrorSophie): item is AlreadyDelegating =>
  ...
  InsufficientFundsForMir: {
    assert: (item: SubmitTxErrorSophie): item is InsufficientFundsForMir =>
  ...
  TooLateForMir: {
    assert: (item: SubmitTxErrorSophie): item is TooLateForMir =>
  ...
  MirTransferNotCurrentlyAllowed: {
    assert: (item: SubmitTxErrorSophie): item is MirTransferNotCurrentlyAllowed =>
  ...
  MirNegativeTransferNotCurrentlyAllowed: {
    assert: (item: SubmitTxErrorSophie): item is MirNegativeTransferNotCurrentlyAllowed =>
  ...
  MirProducesNegativeUpdate: {
    assert: (item: SubmitTxErrorSophie): item is MirProducesNegativeUpdate =>
  ...
  DuplicateGenesisVrf: {
    assert: (item: SubmitTxErrorSophie): item is DuplicateGenesisVrf =>
  ...
  NonGenesisVoters: {
    assert: (item: SubmitTxErrorSophie): item is NonGenesisVoters =>
  ...
  UpdateWrongEpoch: {
    assert: (item: SubmitTxErrorSophie): item is UpdateWrongEpoch =>
  ...
  ProtocolVersionCannotFollow: {
    assert: (item: SubmitTxErrorSophie): item is ProtocolVersionCannotFollow =>
  ...
  OutsideOfValidityInterval: {
    assert: (item: SubmitTxErrorSophie): item is OutsideOfValidityInterval =>
  ...
  TriesToForgeBcc: {
    assert: (item: SubmitTxErrorSophie): item is TriesToForgeBcc =>
      (item as TriesToForgeBcc).triesToForgeBcc !== undefined,
    Error: class TriesToForgeBccError extends CustomError {
      public constructor (rawError: TriesToForgeBcc) {
        super()
        this.message = safeJSON.stringify(rawError)
      }
    }
  ...
  TooManyAssetsInOutput: {
    assert: (item: SubmitTxErrorSophie): item is TooManyAssetsInOutput =>
  ...
  MissingRequiredRedeemers: {
    assert: (item: SubmitTxErrorSophie): item is MissingRequiredRedeemers =>
  ...
  ExtraDataMismatch: {
    assert: (item: SubmitTxErrorSophie): item is ExtraDataMismatch =>
  ...
  MissingRequiredSignatures: {
    assert: (item: SubmitTxErrorSophie): item is MissingRequiredSignatures =>
  ...
  MissingDatumHashesForInputs: {
    assert: (item: SubmitTxErrorSophie): item is MissingDatumHashesForInputs =>
  ...
  MissingCollateralInputs: {
    assert: (item: SubmitTxErrorSophie): item is MissingCollateralInputs =>
  ...
  CollateralTooSmall: {
    assert: (item: SubmitTxErrorSophie): item is CollateralTooSmall =>
  ...
  CollateralIsScript: {
    assert: (item: SubmitTxErrorSophie): item is CollateralIsScript =>
  ...
  CollateralHasNonBccAssets: {
    assert: (item: SubmitTxErrorSophie): item is CollateralHasNonBccAssets =>
      (item as CollateralHasNonBccAssets).collateralHasNonBccAssets !== undefined,
    Error: class CollateralHasNonBccAssetsError extends CustomError {
      public constructor (rawError: CollateralHasNonBccAssets) {
        super()
        this.message = safeJSON.stringify(rawError.collateralHasNonBccAssets)
      }
    }
  },
  TooManyCollateralInputs: {
    assert: (item: SubmitTxErrorSophie): item is TooManyCollateralInputs =>
  ...
  ExecutionUnitsTooLarge: {
    assert: (item: SubmitTxErrorSophie): item is ExecutionUnitsTooLarge =>
  ...
  OutsideForecast: {
    assert: (item: SubmitTxErrorSophie): item is OutsideForecast =>
  ...
  ValidationTagMismatch: {
    assert: (item: SubmitTxErrorSophie): item is ValidationTagMismatch =>
  ...
  CollectErrors: {
    assert: (item: SubmitTxErrorSophie): item is CollectErrors =>
  ...
  PoolMetadataHashTooBig: {
    assert: (item: SubmitTxErrorSophie): item is PoolMetadataHashTooBig =>
  ...
  MissingRequiredDatums: {
    assert: (item: SubmitTxErrorSophie): item is MissingRequiredDatums =>
  ...
  UnspendableDatums: {
    assert: (item: SubmitTxErrorSophie): item is UnspendableDatums =>
  ...
  UnspendableScriptInputs: {
    assert: (item: SubmitTxErrorSophie): item is UnspendableScriptInputs =>
  ...
  ExtraRedeemers: {
    assert: (item: SubmitTxErrorSophie): item is ExtraRedeemers =>
  ...
  ExtraScriptWitnesses: {
    assert: (item: SubmitTxErrorSophie): item is ExtraScriptWitnesses =>
