...
const isProtocolParameters = (result: Ogmios['QueryResponse[currentProtocolParameters]']['result']): result is ProtocolParametersAurum | ProtocolParametersSophie =>
  (result as ProtocolParametersAurum).coinsPerUtxoWord !== undefined || (result as ProtocolParametersSophie).minUtxoValue !== undefined
 ...
 * @category StateQuery
 */
export const currentProtocolParameters = (context: InteractionContext): Promise<ProtocolParametersAurum | ProtocolParametersSophie> =>
  Query<
    Ogmios['Query'],
    Ogmios['QueryResponse[currentProtocolParameters]'],
    ProtocolParametersAurum | ProtocolParametersSophie
  >({
    methodName: 'Query',
    args: {
