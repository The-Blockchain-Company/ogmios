import { EraMismatch, Ogmios, ProposedProtocolParametersAurum, ProposedProtocolParametersSophie } from '@bcc-ogmios/schema'
...
): Promise<ProposedProtocolParametersSophie | ProposedProtocolParametersAurum | null> =>
  Query<
    Ogmios['Query'],
    Ogmios['QueryResponse[proposedProtocolParameters]'],
    ProposedProtocolParametersSophie | ProposedProtocolParametersAurum | null
  >({
    methodName: 'Query',
    args: {
